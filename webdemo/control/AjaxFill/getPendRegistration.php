...
$rs=$obj->simplefetch("select r.*,u.user_name from register as r  left join web_users as u on u.user_id=r.entry_by where admin_approved_status='pending' order by id desc $LimitQry");
