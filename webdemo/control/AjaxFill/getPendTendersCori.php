...
LEFT JOIN (select tr.t_temp_id,tr.revive_by,tr.revive_on,tr.revive_details,ru.user_name from web_tender_revive tr
 ...
 where tt.`status`='Active' and tt.t_cat_id= ".$_REQUEST['t_cat_id']." and tt.corrigendum=1 and tt.app_reject is null and tr1.t_temp_id is null order by tt.t_temp_id DESC $LimitQry");
if($rs[0]>0){
