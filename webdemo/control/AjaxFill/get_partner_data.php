...
// }
if($_REQUEST['pos_cat']!='' && $_REQUEST['pos_cat']!=0){
  $where.=" and pos_cat_id='".$_REQUEST['pos_cat']."'";
}
...
$rs=$obj->simplefetch("select * from partner_reg $where order by part_id desc");
            ...
            foreach($rs[1] as $row){
                ...
                $data[] = array(++$sNo,
					...
					$row['prop_name'],
					 ...
					 <i class=\"fa fa-eye Lpreview\" data-toggle=\"tooltip\" aria-hidden=\"true\" cdata-frmT='7' data-part_id='$row[part_id]' title='Preview'></i>
