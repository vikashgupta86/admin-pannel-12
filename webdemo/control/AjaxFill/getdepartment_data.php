...
$rs=$obj->simplefetch("select * from department where status='Active' order by id desc $LimitQry");
            ...
            foreach($rs[1] as $row){
                $data[] = array(++$sNo,
                    ...
                    "<div class=\"text-center tools\">
                        ...
                        <i class=\"fa fa-trash-o\" data-toggle=\"tooltip\"  cdata-frmT='3' data-link_temp_id='$row[id]' title='Delete Department'></i>                      
                    </div>",
                );
            }
        }
