...
where dlm.`status`='Active' and lf.status='Active' and dlm.lang_id=$_REQUEST[lang_id] and wlt.continuous_content=0 and dlm.link_type_id=$_REQUEST[type_id] and dlm.dept_id=$_REQUEST[dep_id] and dlm.user_id=$_REQUEST[dep_user_id] $usr_session order by wlt.link_temp_id DESC $LimitQry",1);
