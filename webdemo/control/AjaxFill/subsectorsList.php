...
$rs=$obj->simplefetch("select * from neca_subsectors where status ='Active'",1);
if($rs[0]>0){
    ...
    foreach($rs[1] as $row){                
        ...
        $data[] = array(++$sNo,
            ...
            "<div class=\"text-center tools\">
                <i class=\"fa fa-edit\" data-toggle=\"tooltip\" id='edit' cdata-frmT='9' data-subsector_id='$row[subsector_id]' title='Edit'></i>
                <i class=\"fa fa-trash-o\" data-toggle=\"tooltip\" id='delete' cdata-frmT='3' data-subsector_id='$row[subsector_id]' title='Delete'></i>
            </div>",
        );
    }
}
