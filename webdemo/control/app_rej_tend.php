    ...
    <script type="text/javascript">        
            ...
            if($.inArray(frmType,['3','4'])!='-1'){
                ...
                if(con){                        
                    ...
                    $.ajax({
                        ...
                        dataType: "text",
                        cache    : false,
                        url      : '<?php echo "revive_tender_action.php?per_id=$_SESSION[per_id]&EncHid=$_SESSION[EncTok]";?>',
                ...
                $('.modal-container').OpenPop({
                    url:"revive_tender.php?frmType=" + frmType + "&t_temp_id=" + $(this).data('t_temp_id') + "&t_cat_id=<?php echo "$_REQUEST[t_cat_id]";?>&per_id=<?php echo "$_SESSION[per_id]&EncHid=$_SESSION[EncTok]";?>",
                });
            }
        });
        ...
        $(function(){
            var mGridTable=$('table#myTable1').DataTable( {
                        ...
                        "serverSide": false,
                        "ajax": {
                            "url":"AjaxFill/getPendTenders.php?<?php echo "EncHid=$_SESSION[EncTok]";?>",
                            "type":"POST",
