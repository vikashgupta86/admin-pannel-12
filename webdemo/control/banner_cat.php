...
<h2 class="h5 content-header text-dark">Set Banner Category</h2>
...
<!-- 
            ...
            <h2 class="h5 border-bottom pb-2 mb-4 text-dark" style="font-weight: 400;">Set Banner Category</h2>
                ...
                <table class="table table-striped table-bordered align-middle small mb-0">
                    <thead>
                        <tr class="text-nowrap" style="color: #333;">
                            ...
                            <th style="width: 25%;">Category Name <i class="bi bi-arrow-down-up text-muted ms-1" style="font-size: 10px;"></i></th>
                            <th style="width: 25%;">Category Name (Hindi) <i class="bi bi-arrow-down-up text-muted ms-1" style="font-size: 10px;"></i></th>
                            <th style="width: 15%;">Cover Image <i class="bi bi-arrow-down-up text-muted ms-1" style="font-size: 10px;"></i></th>
                            <th style="width: 20%;">Published On <i class="bi bi-arrow-down-up text-muted ms-1" style="font-size: 10px;"></i></th>
                            <th style="width: 10%;" class="text-center">Set as Banner</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td colspan="6" class="text-center text-muted py-3">No data available in table</td>
                        </tr>
                        ...
                        <table id="myTable1" class="table table-striped table-bordered" cellspacing="0" width="100%">                            
                            <thead>
                                <tr>
                                    ...
                                    <th>Cover Image</th>                                    
                                    <th>Published On</th>                                                                                    
                                    <th class="text-center">Set as Banner</th>                                    
                                </tr>
                            </thead>
                        </table>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            mGridTable=$('table#myTable1').DataTable( {
                        ...
                        "serverSide": false,
                        "ajax": {
                            "url":"AjaxFill/get_mCat.php?<?php echo "EncHid=$_SESSION[EncTok]";?>",
                            "type":"POST",
