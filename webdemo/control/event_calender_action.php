...
try {
    ...
    $FielArr = array(
        'event_name' => htmlspecialchars(trim($event_name), ENT_QUOTES),
        'event_start_date' => date('Y-m-d', strtotime($strt_date)),
        'event_end_date' => date('Y-m-d', strtotime($end_date)),
        'event_desc' => htmlspecialchars(trim($evnt_desc), ENT_QUOTES),
