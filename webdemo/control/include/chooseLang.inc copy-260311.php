...
<form name="frm" id="frm" action="<?php echo curPageName()."?EncHid=$_SESSION[EncTok]"?>" role="form" method="post">
    ...
    <input type="hidden" name="dept_type_id" id="dept_type_id" value="1" />                                         
    ...
    <?php
        ...
        */
		...
		<?php 
            ...
            #}else{  
        ?> 
		    <!--<input type="hidden" name="dept_type_id" id="dept_type_id" value="<?php //echo $_SESSION['department_type'];?>">-->
		<?php #} ?>
        ...
        <div class="text-center">
            <button type="submit" class="btn btn-primary rounded-0 px-4" id="proceedBtn" style="background-color: #337ab7; border-color: #2e6da4;">Proceed</button>
        </div>
