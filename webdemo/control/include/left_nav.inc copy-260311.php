              ...
              if($rsmodule){
                foreach ($rsmodule as $rowmodule){
                  ...
                  ?>
                      ...
                      <a href="#block_<?php echo $rowmodule['module_id'];?>" data-bs-toggle="collapse" aria-expanded="false" class="nav-link d-flex justify-content-between align-items-center">
                        <span>
