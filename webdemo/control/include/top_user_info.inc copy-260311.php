    ...
    <div class="main-content">
        <header class="top-navbar">
            ...
            <div class="timer-section d-flex align-items-center flex-grow-1 justify-content-center justify-content-md-center mt-2 mt-md-0">
                ...
                <button class="btn btn-light btn-sm rounded-0 py-0" style="font-size: 12px;">Reset Session</button>
            </div>
            <div class="dropdown">
                <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="https://via.placeholder.com/25" class="rounded-circle me-2" alt="User">
                ...
                <ul class="dropdown-menu dropdown-menu-end rounded-0 shadow-sm mt-2" aria-labelledby="profileDropdown">
                    <li><a class="dropdown-item small" href="<?php echo base_url()."/control/u_profile.php?per_id=$rowsubmodule[per_id]&amp;EncHid=$_SESSION[EncTok]";?>"><i class="bi bi-person me-2 text-muted"></i> Profile Details</a></li>
                    <li><a class="dropdown-item small" href="#"><i class="bi bi-key me-2 text-muted"></i> Change Password</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item small text-danger fw-bold" href="#"><i class="bi bi-box-arrow-right me-2"></i> Logout</a></li>
                </ul>
            </div>
        </header>
