          ...
          <div class="content-wrapper">
            <div class="box">
                <div class="box-header">
                 <h2 class="h5 border-bottom pb-2 mb-4 text-dark" style="font-weight: 400;">Manage Home Page Photogallery</h2>
                ...
                <div class="box-body clearfix">                    
                    <div class="panel panel-default">                        
                        ...
                        <h4 class="text-center">Manage PhotoGalley</h4>
                        <input type="hidden" name="m_cat_id" id="m_cat_id" value="<?php echo $_REQUEST['m_cat_id'];?>" />
						<input type="hidden" name="nmnh_type_id_hp" id="nmnh_type_id_hp" value="<?php echo $_REQUEST['nmnh_type_id'];?>" />
    ...
    <script type="text/javascript">
        ...
        $(function(){
            mGridTable=$('table#myTable1').DataTable( {
                        ...
                        "serverSide": false,
                        "ajax": {
                            "url":"AjaxFill/get_medImg.php?<?php echo "EncHid=$_SESSION[EncTok]";?>",
                            "type":"POST",
                            "data":{<?php echo $GLOBALS['csrf']['token'];?>,'m_cat_id':'<?= $_REQUEST['m_cat_id'] ?? '';?>','per_id':'<?php echo "$_REQUEST[per_id]";?>','nmnh_type_hp':'<?= $_REQUEST['nmnh_type_id_hp'] ?? '';?>'}
                            },
                        scrollY:        400,
                        scrollX: true,
                        scrollCollapse: true,
