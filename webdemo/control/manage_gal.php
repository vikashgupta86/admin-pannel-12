...
<h2 class="h5 content-header text-dark">Manage Home Page Photogallery</h2>
        ...
        $(function(){
            mGridTable=$('table#myTable1').DataTable( {
                        ...
                        "ajax": {
                            ...
                            "type":"POST",
                            "data":{<?php echo $GLOBALS['csrf']['token'];?>,'m_cat_id':'<?= $_REQUEST['m_cat_id'] ?? '';?>','per_id':'<?= $_REQUEST['per_id'] ?? '';?>','nmnh_type_hp':'<?= $_REQUEST['nmnh_type_id_hp'] ?? '';?>'}
                            },
                        scrollY:        400,
                        scrollX: true,
                        scrollCollapse: true,
