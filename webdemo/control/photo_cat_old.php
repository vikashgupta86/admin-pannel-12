            ...
            <div class="modal-body">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="c_name" id="c_name" placeholder="Category Name" value="<?php echo ($row['cat_name'] ?? '');?>" data-validate="c_name|text|y|1|500|alnum_spcA|Please enter Valid Category Name!"/>
                    </div>
