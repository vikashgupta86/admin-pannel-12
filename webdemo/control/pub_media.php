...
<h2 class="h5 content-header text-dark">Publish Media</h2>
    ...
    <script type="text/javascript">        
            ...
            if($.inArray(frmType,['3','4'])!='-1'){
                ...
                if(con){                        
                    ...
                    $.ajax({
                        ...
                        dataType: "text",
                        cache    : false,
                        url      : '<?php echo "media_pub_action.php?per_id=$_SESSION[per_id]&amp;EncHid=$_SESSION[EncTok]";?>',
                ...
                $('.modal-container').OpenPop({
                    url:"media_pub.php?frmType=" + frmType + "&m_temp_id=" + $(this).data('m_temp_id') + "&per_id=<?php echo "$_SESSION[per_id]&EncHid=$_SESSION[EncTok]";?>",
                    title: 'Publish Media'
                });
            }
        });
        ...
        $(function(){            
            var mGridTable=$('table#myTable1').DataTable( {
                        ...
                        "serverSide": false,
                        "ajax": {
                            "url":"AjaxFill/getPubMedia.php?<?php echo "EncHid=$_SESSION[EncTok]";?>",
                            "type":"POST",
