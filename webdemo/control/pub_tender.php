...
?>
    ...
    if(isset($_REQUEST['frmType']) && $_REQUEST['frmType'] == 1){
        ...
        if($rs[0]<=0){
            ...
            foreach($rs[1] as $row);
    ?>
              <h4 class="modal-title">Publish Tenders</h4>
      
              <form name="formNC" id="formNC" method="post" autocomplete="off" role="form" action="<?php echo "pub_tender_action.php?per_id=$_SESSION[per_id]&amp;EncHid=$_SESSION[EncTok]";?>" enctype="multipart/form-data" >
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="input-group">
                        <input type="date" class="form-control" name="link_pubDate" id="link_pubDate" placeholder="DD-MM-YYYY" value="<?php echo $row['pub_date'] ?? '';?>" data-validate="link_pubDate|text|y|10|10|dt|Please enter/ select Valid Date!"/>
                    ...
                    <div class='input-group date ptime'>
                        <input type='time' name="ptime" id="ptime" class="form-control ptime" value="<?php echo $row['pub_time'] ?? '';?>" data-validate="ptime|text|n|5|5|ti|Please enter/ select Valid Time!" />
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="input-group">
                        <input type="date" class="form-control" name="link_expDate" id="link_expDate" placeholder="DD/MM/YYYY" value="<?php #echo html_entity_decode($row['link_name']);?>" data-validate="link_expDate|text|y|10|10|dt|Please enter/ select Valid Date!"/>
                        <span class="input-group-addon CopyIcon" data-for='link_expDate'><span class="glyphicon glyphicon-calendar"></span></span>
                      </div>                      
                    </div>
                    <div class="form-group col-md-6">
                     <label for="ptime">Expired Time:</label>
                    <div class='input-group date ptime'>
                        <input type='time' name="ctime" id="ctime" class="form-control ctime" value="<?php echo $row['close_time'] ?? '';?>" data-validate="ptime|text|n|5|5|ti|Please enter/ select Valid Time!" />
                        <span class="input-group-addon">
                            <span class="glyphicon glyphicon-time"></span>
                        </span>
                    </div>
                    ...
                    <!--<div class="form-group col-md-6">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control" name="link_nrevDate" id="link_nrevDate" placeholder="DD/MM/YYYY" value="<?php #echo html_entity_decode($row['link_name']);?>" data-validate="link_nrevDate|text|n|10|10|dt|Please enter/ select Valid Date!"/>
