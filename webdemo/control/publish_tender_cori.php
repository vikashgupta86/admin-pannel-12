...
?>
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
          ...
          <h3 class="box-title">Publish Tender Corrigendum</h3>
    ...
    <script <?= $nonce; ?>  type="text/javascript">        
        $(document).delegate('.fa-desktop', 'click', function() {
            ...
            if($.inArray(frmType,['3','4'])!='-1'){
                ...
                $('.modal-container').OpenPop({
                    ...
                    url:"pub_tenderCori.php?frmType=" + frmType + "&t_temp_id=" + $(this).data('t_temp_id') + "&t_id=" + $(this).attr('ten-t_id') + "&lang_id=<?php echo "$_REQUEST[lang_id]";?>&type_id=<?php echo $_REQUEST['type_id'] ?? '';?>&per_id=<?php echo "$_SESSION[per_id]&EncHid=$_SESSION[EncTok]";?>",
                    title:"Publish Tender Corrigendum"
                });
            }
        });
        ...
        $(function(){            
            var mGridTable=$('table#myTable1').DataTable( {
                        ...
                        "serverSide": false,
                        "ajax": {
                            "url":"AjaxFill/getPubTendersCori.php?<?php echo "EncHid=$_SESSION[EncTok]";?>",
                            "type":"POST",
