            ...
            <div class="modal-body">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="l_name" id="l_name" placeholder="Tender Name" value="<?php echo html_entity_decode($row['tender_name'] ?? '');?>" data-validate="l_name|text|y|1|500|alnum_spc|Please enter Valid Link Name!"/>
                    </div>
                    
                    <div class="form-group">
                      <label for="l_title">Title</label>
                      <input type="text" class="form-control" name="l_title" id="l_title" placeholder="Title" value="<?php echo html_entity_decode($row['title'] ?? '');?>" data-validate="l_title|text|y|1|500|alnum_spc|Please enter Valid Link Title!"/>
                    </div>
                        
                    <div class="form-group">
                      <label for="t_num">Tender Number</label>
                      <input type="text" class="form-control" name="t_num" id="t_num" placeholder="Tender Number" value="<?php echo html_entity_decode($row['t_num'] ?? '');?>" data-validate="t_num|text|y|1|500|alnum_spc|Please enter Valid Link Title!"/>
                    </div>
                        
                    <div class="form-group">
                      <label for="l_bdesc">Brief Description:</label>
                      <textarea class="form-control" name="l_bdesc" id="l_bdesc" placeholder="Brief Description of the Link" data-validate="l_bdesc|textarea|n|1|2000|alnum_spc|Please enter Valid data!"><?php echo html_entity_decode($row['link_bdesc'] ?? '');?></textarea>
                    </div>
                    ...
                    <!--<div class="row">
                        <div class="form-group col-md-6">
                          ...
                          <div class="input-group">
                            <input type="text" class="form-control" name="link_pubDate" id="link_pubDate" placeholder="DD/MM/YYYY" value="<?php //echo $row['pub_date'];?>" data-validate="link_pubDate|text|n|10|10|dt|Please enter/ select Valid Date!"/>
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" name="l_file" id="l_file" data-validate="l_file|file|<?php echo $Mand;?>|1|30000|file_extn=pdf|Please Select file,Filename should not contain any special character and white space. Invalid Filename! Allowed extenstions are pdf!"/>
                      <?php
