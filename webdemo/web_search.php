...
try {
    ...
    $sql = "
        SELECT
            ...
            END AS lfile,
            lf.lid,
            MIN(ls.ls_id) AS ls_id, -- Take the first occurrence of the structure ID
            ls.parent_ls_id,
            lt.link_name,
            lt.title,
            lt.type_id,
        ...
        LEFT JOIN web_link_temp lt ON lt.link_temp_id = lf.link_temp_id
        LEFT JOIN web_links_structure ls ON ls.lid = lf.lid
        ...
        GROUP BY lf.lid, lt.link_name -- This ensures uniqueness 
